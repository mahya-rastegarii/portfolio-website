...
export default function AboutPage() {
  ...
  return (
    <section className="min-h-screen h-screen px-6 z-40 py-20 md:px-24 w-full text-white flex flex-col justify-center items-center overflow-scroll md:overflow-hidden pt-10 md:pt-0">
