...
export default function ContactMe() {
 ...
 const t = useI18n();
  ...
  return (
    <div dir={locale === "fa" ? "rtl" : "ltr"} className="w-full md:w-[80%] lg:w-[90%] xl:w-[80%] z-40 flex flex-col justify-center items-center lg:flex-row gap-2 mt-32 pt-32 lg:pt-0 mb-20 lg:mb-0  lg:mt-24">

          <div className="flex flex-col justify-center  items-start space-y-4 w-full lg:w-2/4">

          <div className=' w-full flex justify-center lg:w-fit lg:justify-start  pt-24 lg:pt-0 mt-32 lg:mt-0 lg:mb-9 '>
