...
export default function AboutContent() {
  ...
  return (
    <div className={` w-full  xl:w-[80%]  flex flex-col justify-center items-center md:items-end  pt-10 md:pt-20 lg:pt-0 md:flex-row mt-20 mb-5 md:mb-0  md:mt-0 ${locale === "fa" ? "md:flex-row-reverse" : "md:flex-row"} gap-10`}>
